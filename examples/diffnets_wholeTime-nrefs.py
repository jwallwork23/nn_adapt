...
parser.add_argument("--nrefs_start", 
                    help="same as python slicing, incl.",
                    type=int,
                    default="19")
parser.add_argument("--nrefs_end", 
                    help="same as python slicing, eexcl",
                    type=int,
                    default="25")
...
# taylor nrefs, same as python slicing
n_refinements = np.arange(nrefs_start, nrefs_end) 
...
plt.title(f"Whole Times vs {nrefs_start}th to {nrefs_end}th (Python list indexing) Refinements")
